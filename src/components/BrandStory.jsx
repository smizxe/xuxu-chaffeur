        ...
        <section id="about" className="py-24 px-6 md:px-12 relative max-w-7xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                <div className="relative z-10 order-2 lg:order-1">
                    <div className="inline-block bg-[#A67C52] text-[#3E2723] font-bold px-3 py-1 rounded border-2 border-[#3E2723] mb-6 shadow-[2px_2px_0px_0px_#3E2723]" data-aos="fade-up">
                        {lang === 'EN' ? "OUR STORY" : "CÂU CHUYỆN CỦA CHÚNG TÔI"}
                    </div>
                    <h2 className="text-5xl md:text-7xl font-bold tracking-tighter text-[#3E2723] mb-8 leading-[0.9]" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div className="space-y-6 text-xl text-[#3E2723]/80 font-medium" data-aos="fade-up" data-aos-delay="400">
                        <p>
                    ...
                    <div className="mt-10 flex flex-wrap gap-4" data-aos="fade-up" data-aos-delay="600">
                ...
                <div className="relative h-[500px] w-full order-1 lg:order-2" data-aos="fade-left" data-aos-delay="300">
                    {/* Abstract Graphic */}
