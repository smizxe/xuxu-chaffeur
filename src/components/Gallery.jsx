    ...
    return (
        <section id="gallery" className="py-24 bg-[#8B6D51] relative overflow-hidden text-[#FBF7F0] border-t-4 border-[#3E2723]">
            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10 text-center mb-16">
                <h2 className="text-5xl md:text-6xl font-black tracking-tight mb-4" data-aos="fade-up">
                    {lang === 'EN' ? "Moments of " : "Khoảnh Khắc "}<span className="font-serif italic text-[#A67C52]">{lang === 'EN' ? "Joy" : "Yêu Thương"}</span>
                </h2>
                <p className="text-xl font-medium text-[#FBF7F0]/80 max-w-2xl mx-auto" data-aos="fade-up" data-aos-delay="200">
            ...
            <div className="max-w-7xl mx-auto px-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div className="space-y-6">
                        <div className="rounded-2xl overflow-hidden border-2 border-[#3E2723] hard-shadow bg-gray-200" data-aos="fade-up" data-aos-delay="300">
                        ...
                        <div className="rounded-2xl overflow-hidden border-2 border-[#3E2723] hard-shadow bg-gray-200" data-aos="fade-up" data-aos-delay="400">
                    ...
                    <div className="space-y-6 lg:mt-12">
                        <div className="rounded-2xl overflow-hidden border-2 border-[#3E2723] hard-shadow bg-gray-200 relative" data-aos="fade-up" data-aos-delay="500">
                        ...
                        <div className="rounded-2xl overflow-hidden border-2 border-[#3E2723] hard-shadow bg-gray-200" data-aos="fade-up" data-aos-delay="600">
                    ...
                    <div className="space-y-6">
                        <div className="rounded-2xl overflow-hidden border-2 border-[#3E2723] hard-shadow bg-gray-200" data-aos="fade-up" data-aos-delay="700">
                        ...
                        <div className="rounded-2xl overflow-hidden border-2 border-[#3E2723] hard-shadow bg-gray-200" data-aos="fade-up" data-aos-delay="800">
